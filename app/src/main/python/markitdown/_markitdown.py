...
try:
    import magika  # Optional: unavailable on Android (requires onnxruntime, no Android wheel)
except ImportError:
    magika = None
...
class MarkItDown:
        ...
        **kwargs,
        ...
        if magika is not None:
            try:
                ...
                # Magika is a best-effort enhancement; fall back to
                # extension/mimetype-based detection when unavailable.
                self._magika = None
    ...
    def _get_stream_info_guesses(
        ...
        # Call magika to guess from the stream. This is a best-effort
        # enhancement: on platforms where magika/onnxruntime is unavailable
        # (e.g. Android) we fall back to the extension/mimetype-based guess.
        if self._magika is not None:
            ...
            # magika unavailable: rely on the extension/mimetype-based guess.
            guesses.append(enhanced_guess)

...
# Load dependencies. pdfminer.six is pure Python and required. pdfplumber is
# optional: it needs pypdfium2 (no Android wheel), so when it is missing we
# fall back to plain pdfminer text extraction (the broad `except Exception`
# in convert() already routes to pdfminer in that case).
